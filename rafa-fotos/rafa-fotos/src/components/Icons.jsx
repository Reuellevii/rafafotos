...
export const IconWhatsApp = ({ size = 22 }) => (
  <svg {...base} width={size} height={size} strokeWidth={1.5}>
    ...
    <path d="M14.5 12.5c-.2-.1-.8-.4-1-.5-.2 0-.3 0-.4.2-.1.2-.4.5-.5.6-.1.1-.2.1-.4 0-.2-.1-.8-.3-1.5-1-.5-.5-.9-1.1-1-1.3 0-.2 0-.3.1-.4l.3-.3s.1-.2 0-.3c0-.1-.4-1-.6-1.3-.2-.3-.3-.3-.4-.3h-.3s-.3 0-.5.2c-.2.2-.7.7-.7 1.7 0 1 .7 2 1 2.4 1.3 1.8 3.1 2.3 3.6 2.5.3.1.8.2 1.1.1.4 0 1.2-.5 1.4-1 .2-.5.2-.9.1-1z" />
  </svg>
)
