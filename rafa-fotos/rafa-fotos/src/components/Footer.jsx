      ...
      <div className="container footer__grade">
        ...
        <div className="footer__redes">
          <ul>
            ...
            <li>
              <a href="https://banlek.com/rafafotosoros" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', color: 'inherit', textDecoration: 'none' }}>
